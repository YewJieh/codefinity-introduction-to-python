...
distance_in_miles =4677.4 /1.609

# Convert variable type to int and store in `int_distance_in_miles`
int_distance_in_miles= int(distance_in_miles)

# Testing
print("San Francisco - New York distance (float): ", distance_in_miles, "miles")
print("San Francisco - New York distance (int): ", int_distance_in_miles, "miles")